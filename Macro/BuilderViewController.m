...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[Species availableStructuresForPlayer:self.gameInstance.localPlayer] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    NSArray *structures = [Species availableStructuresForPlayer:self.gameInstance.localPlayer];
    Structure *currentStructure = [structures objectAtIndex:indexPath.row];
    cell.textLabel.text = [NSString stringWithFormat:@"%@ - %iM, %iG",  currentStructure.title, currentStructure.mineralCost, currentStructure.gasCost];
