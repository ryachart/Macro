...
-(id)initWithGameInstance:(GameInstance*)instance andStructure:(Structure*)newStructure;
{
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[Species availableUnitsForPlayer:self.gameInstance.localPlayer fromStructure:self.structure] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Unit *currentUnit = [units objectAtIndex:[indexPath row]];
    cell.textLabel.text = [NSString stringWithFormat:@"%@ | %iM, %iG", [currentUnit title], currentUnit.mineralCost, currentUnit.gasCost];
